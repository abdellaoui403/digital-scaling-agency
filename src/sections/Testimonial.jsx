    ...
    <section className="relative z-2 py-24 md:py-28 lg:py-40">
      <div className="container block lg:flex">
        <div className="testimonials_head-res relative z-2 mr-20 flex-300">
          <p className="caption mb-5 max-md:mb-2.5">Testimonial</p>
          <h3 className="h3 max-md:h5 text-p4">Words from our clients</h3>
        </div>

        <div className=" testimonials_inne-before relative -my-12 -mr-3 flex items-start max-lg:static max-md:block">
